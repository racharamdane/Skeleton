...
<head runat="server">
    ...
    <title>Zorpz Management Ltd — Doctor Data Entry</title>
    ...
    <style>
        /* =========================================================
           ZORPZ MANAGEMENT LTD — DOCTOR DATA ENTRY
           ========================================================= */
        :root {
            --brand-olive:       #6B7355;
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            <p class="page-header__eyebrow">Staff Records Module</p>
            <div class="page-header__icon">
                <svg viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
            </div>
            <h1 class="page-header__title">Doctor <em>Data Entry</em></h1>
            <p class="page-header__sub">Create or update a professional medical record</p>
        </section>
        ...
        <div class="form-card">
            <div class="form-body">
                ...
                <div class="form-section">
                    <div class="form-section__label">Identity &amp; Account</div>

                    <div class="form-row">
                        <div class="field">
                            <label class="field__label" for="<%= txtDoctorId.ClientID %>">Doctor ID</label>
                            <asp:TextBox ID="txtDoctorId" runat="server"
                                CssClass="aspnet-input"
                                placeholder="e.g. DOC-00123" />
                        </div>
                        <div class="field">
                            <label class="field__label" for="<%= txtContractDate.ClientID %>">Contract Date</label>
                            <asp:TextBox ID="txtContractDate" runat="server"
                                CssClass="aspnet-input"
                    ...
                    <div class="form-row full">
                        <div class="field">
                            <label class="field__label" for="<%= txtFullName.ClientID %>">Full Name</label>
                            <asp:TextBox ID="txtFullName" runat="server"
                                CssClass="aspnet-input"
                                placeholder="Dr. First and Last Name" />
                        </div>
                    </div>

                    <div class="form-row">
                        <div class="field">
                            <label class="field__label" for="<%= txtDepartment.ClientID %>">Department</label>
                ...
                <div class="form-section">
                    <div class="form-section__label">Credentials &amp; Security</div>

                    <div class="form-row">
                        <div class="field">
                            <label class="field__label" for="<%= txtEmail.ClientID %>">Email Address</label>
                            <asp:TextBox ID="txtEmail" runat="server"
                                CssClass="aspnet-input"
                                TextMode="Email"
                                placeholder="doctor@zorpz.com" />
                        </div>
                        <div class="field">
                            <label class="field__label" for="<%= txtPassword.ClientID %>">Password</label>
                ...
                <div class="form-section">
                    <div class="form-section__label">Status</div>

                    <label class="checkbox-field">
                        <asp:CheckBox ID="chkAvailability" runat="server" />
                        <span class="checkbox-field__text">Doctor is currently available for appointments</span>
                    </label>
                </div>
            ...
            <div class="action-bar">
                <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click1"
                    Text="Save Record"
