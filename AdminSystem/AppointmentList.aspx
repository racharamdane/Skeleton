...
<asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" style="z-index: 1; left: 20px; top: 543px; position: absolute" Text="Add" />
        <asp:Button ID="btnEdit" runat="server" OnClick="btnEdit_Click" style="z-index: 1; left: 60px; top: 544px; position: absolute" Text="Edit"/>
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 42px; top: 725px; position: absolute"></asp:Label>
    </p>
           <p>
            <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" style="z-index: 1; left: 101px; top: 543px; position: absolute" Text="Delete" />
            </p>
        ...
        <asp:Label ID="lblEnterAppointmentId" runat="server" style="z-index: 1; left: 29px; top: 577px; position: absolute" Text="Enter AppointmentId"></asp:Label>
 <p>
            <asp:TextBox ID="txtFilter" runat="server" style="z-index: 1; top: 574px; position: absolute; left: 161px"></asp:TextBox>
 </p>
    </form>
</body>
</html>
